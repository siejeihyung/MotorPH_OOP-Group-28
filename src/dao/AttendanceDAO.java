 ...
 * ONLY responsibility: read and write attendance.txt.
 */
public class AttendanceDAO {
    ...
    public void load() {
        ...
        try (CSVReader reader = new CSVReaderBuilder(new FileReader(file))
            ...
            System.out.println("✅ attendance.txt loaded: " + data.size() + " rows");
    ...
    public void save() {
        try (ICSVWriter writer = new CSVWriterBuilder(new FileWriter(ATTENDANCE_FILE))
            ...
            System.out.println("✅ attendance.txt saved.");
        } catch (IOException e) {
            System.out.println("❌ Error writing attendance.txt: " + e.getMessage());
        }
    }
