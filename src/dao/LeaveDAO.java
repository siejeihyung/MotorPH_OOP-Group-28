...
/**
 * LeaveDAO — reads and writes leave.txt.
...
public class LeaveDAO {
    ...
    public void load() {
        ...
        if (!file.exists()) {
            System.out.println("leave.txt not found — will be created on first save.");
            return;
        }
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            System.out.println("✅ leave.txt loaded: " + data.size() + " rows");
        } catch (IOException e) {
